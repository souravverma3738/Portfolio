  ...
  experience: [
    {
      ...
      achievements: [
        ...
        "Built RESTful APIs with database integration using Domain-Driven Design and Deployed containerized applications on cloud Infrastructure.",
        ...
        "Implemented an automated testing for finding Bug and designed event-driven workfolows for real-time updates. Experienced collaborating with Product Owners, UX Designers."
      ],
      technologies: ["JavaScript", "React", "Python", "C#", "PostgreSQL", "Docker", ".Net", "Azure", "Agile Methodology", "Pytest", "XUnit"]
    },
    {
      id: 2,
